// тут создаем папку
// а тут создаем папку в этой папке
// а тут создаем папку в папке в этой папке
// а здесь еще создаем папку в папке, которая в папке в этой папке
// снова создаем папку в папке, которая в папке, которая еще раз в папке, которая в
//                                                   свою очередь находится в папке
